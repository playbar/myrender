...
namespace Baofeng
{
	namespace Mojing
	{
		...
		void ControllerInfo::ParseMMapData(MMapedControllerData* pMMapData)
		{
            ...
            {
                char msg[1024];
                sprintf(msg, "ParseMMapData Current Orientation (%f / %f / %f / %f), FixData Orientation (%f / %f / %f / %f), AngularAcceleration(%f / %f / %f), LinearAcceleration(%f / %f / %f)", \
                    pMMapData->m_JoyStick[m_cid - 1].CurrentData.m_Orientation[0], pMMapData->m_JoyStick[m_cid - 1].CurrentData.m_Orientation[1], pMMapData->m_JoyStick[m_cid - 1].CurrentData.m_Orientation[2], pMMapData->m_JoyStick[m_cid - 1].CurrentData.m_Orientation[3], \
