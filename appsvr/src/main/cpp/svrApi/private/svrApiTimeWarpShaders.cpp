...
char svrEyeBufferSeparateVs_Mojing_NoOverlayAndCAC[] =
"#version 300 es\n"
"\n"
...
char svrEyeBufferSeparateFs_Mojing_NoOverlayAndCAC[] =
"#version 300 es\n"
"\n"
"precision highp float;\n"
"\n"
...
"   if (vEyeType.x < 0.5f)\n"
"   {\n"
"    outColor = texture(srcTex, vTexcoordG.xy);\n"
"   }\n"
"   else\n"
"   {\n"
"    outColor = texture(srcTex2, vTexcoordG.xy);\n"
"   }\n"
"   }\n"// end of
"\n"
"}\n"
