...
namespace Baofeng
{
	namespace Mojing
	{
		...
		{
#if !defined(MJ_ENABLE_THREADS) || defined(MJ_CPU_X86) || defined(MJ_OS_WIN32) || defined(MJ_OS_IPHONE)
...
#elif defined(MJ_CPU_PPC64) || defined(MJ_CPU_PPC)
...
#elif defined(MJ_CC_GNU) && (__GNUC__ >= 4)
		...
		struct AtomicOpsRaw_4ByteImpl : public AtomicOpsRawBase
		{
			...
			typedef LONG T;
#if defined(MJ_CC_MSVC) && (MJ_CC_MSVC < 1300)
...
#elif defined(MJ_CPU_ARM) && defined(MJ_CC_ARM)
			typedef UInt32 T;
...
#elif defined(MJ_CC_GNU) && (__GNUC__ >= 4 && __GNUC_MINOR__ >= 1)
		...
		{
#if !defined(MJ_64BIT_POINTERS) || !defined(MJ_ENABLE_THREADS)
		...
		struct AtomicOpsRaw_DefImpl : public O
		{
			...
			inline static O_T   Exchange_Sync(volatile O_T* p, O_T val)                { O_FullSync    sync; MJ_UNUSED(sync); return AtomicOpsRaw_DefImpl<O>::Exchange_NoSync(p, val); }
			inline static O_T   Exchange_Release(volatile O_T* p, O_T val)             { O_ReleaseSync sync; MJ_UNUSED(sync); return AtomicOpsRaw_DefImpl<O>::Exchange_NoSync(p, val); }
			inline static O_T   Exchange_Acquire(volatile O_T* p, O_T val)             { O_AcquireSync sync; MJ_UNUSED(sync); return AtomicOpsRaw_DefImpl<O>::Exchange_NoSync(p, val); }
			inline static O_T   ExchangeAdd_Sync(volatile O_T* p, O_T val)             { O_FullSync    sync; MJ_UNUSED(sync); return AtomicOpsRaw_DefImpl<O>::ExchangeAdd_NoSync(p, val); }
			inline static O_T   ExchangeAdd_Release(volatile O_T* p, O_T val)          { O_ReleaseSync sync; MJ_UNUSED(sync); return AtomicOpsRaw_DefImpl<O>::ExchangeAdd_NoSync(p, val); }
			inline static O_T   ExchangeAdd_Acquire(volatile O_T* p, O_T val)          { O_AcquireSync sync; MJ_UNUSED(sync); return AtomicOpsRaw_DefImpl<O>::ExchangeAdd_NoSync(p, val); }
			inline static bool  CompareAndSet_Sync(volatile O_T* p, O_T c, O_T val)    { O_FullSync    sync; MJ_UNUSED(sync); return AtomicOpsRaw_DefImpl<O>::CompareAndSet_NoSync(p, c, val); }
			inline static bool  CompareAndSet_Release(volatile O_T* p, O_T c, O_T val) { O_ReleaseSync sync; MJ_UNUSED(sync); return AtomicOpsRaw_DefImpl<O>::CompareAndSet_NoSync(p, c, val); }
			inline static bool  CompareAndSet_Acquire(volatile O_T* p, O_T c, O_T val) { O_AcquireSync sync; MJ_UNUSED(sync); return AtomicOpsRaw_DefImpl<O>::CompareAndSet_NoSync(p, c, val); }
...
#else
			inline static void  Store_Release(volatile O_T* p, O_T val)  { O_ReleaseSync sync; MJ_UNUSED(sync); *p = val; }
#endif
			inline static O_T   Load_Acquire(const volatile O_T* p)      { O_AcquireSync sync; MJ_UNUSED(sync); return *p; }
		};
		...
		struct AtomicOpsRaw<4> : public AtomicOpsRaw_DefImpl<AtomicOpsRaw_4ByteImpl>
		{
			...
			AtomicOpsRaw()
			{
				MJ_COMPILER_ASSERT(sizeof(AtomicOpsRaw_DefImpl<AtomicOpsRaw_4ByteImpl>::T) == 4);
			}
		};
		template<>
		struct AtomicOpsRaw<8> : public AtomicOpsRaw_DefImpl<AtomicOpsRaw_8ByteImpl>
		{
			AtomicOpsRaw()
			{
				MJ_COMPILER_ASSERT(sizeof(AtomicOpsRaw_DefImpl<AtomicOpsRaw_8ByteImpl>::T) == 8);
			}
		};
