                             ...
                             integer_list_gen<Indices...>)
{
  ...
  auto gpu_task = symphony::create_task(std::forward<KernelType>(kernel),
...
struct hexagon_task_launch_wrapper<1> {
                     ...
                     integer_list_gen<Indices...>)
  {
    ...
    auto hexagon_task = symphony::create_task(std::forward<KernelType>(kernel),
...
struct execute_on_dsp {
                            ...
                            const symphony::pattern::tuner&)
  {
    ...
    hexagon_task_launch_wrapper<Dims>::
      launch(g, r, std::forward<decltype(hexagon_kernel)>(hexagon_kernel),
                                arglist,
                                typename integer_list<std::tuple_size<ArgTuple>::value>::type());
  }
};
