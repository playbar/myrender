...
{   
	...
	UNITY_EXPORT bool Unity_Init(const char* szMerchantID, const char* szAppID, const char* szAppKey, const char* szChannelID, int nWidth, int nHeight, float xdpi, float ydpi, const char* szProfilePath)
	{    
