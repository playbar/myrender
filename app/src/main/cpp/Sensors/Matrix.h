...
#ifndef MYRENDER_MATRIX_H
#define MYRENDER_MATRIX_H
...
public:
    ...
    Matrix() {
        memset(sTemp, 0, sizeof(float) * 32);
    }
...
#define I(_i, _j) ((_j)+ 4*(_i))
    ...
    {
        setRotateM(sTemp, 0, a, x, y, z);
        multiplyMM(sTemp,  m,  sTemp );
        memcpy(m, sTemp, sizeof(float) * 16);
