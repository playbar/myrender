...
//public synchronized
    void processGyro(Vector3d &gyro, long sensorTimeStamp) {
...
//public synchronized
    void processAcc(Vector3d &acc, long sensorTimeStamp) {
        mz.set(acc);
...
//public synchronized
    ...
    void magObservationFunctionForNumericalJacobian(Matrix3x3d so3SensorFromWorldPred, Vector3d result) {
