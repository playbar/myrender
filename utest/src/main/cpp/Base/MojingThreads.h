...
#define MJ_WAIT_INFINITE 0xFFFFFFFF
...
namespace Baofeng
{
	namespace Mojing
	{
		...
		public:
			...
			// Delay is specified in milliseconds (1/1000 of a second).
			bool  Wait(unsigned delay = MJ_WAIT_INFINITE);
...
#define MJ_THREAD_EXIT                  0x10
		...
		public:
			...
			static  void MJ_CDECL FinishAllThreads();
			...
			void*          GetOSHandle() const { return (void* )&ThreadHandle; }
#else
...
//			pthread_t           ThreadHandle;
			...
			Thread(const Thread &source) { MJ_UNUSED(source); }

		};

		class ThreadListNode :public ListNode<ThreadListNode >, public Thread
		{
		public:
			ThreadListNode(){};
			virtual ~ThreadListNode(){};
		};
