...
class task_ptr<ReturnType> : public task_ptr<> {
  ...
  static_assert(std::is_reference<ReturnType>::value == false,
                "This version of Qualcomm Symphony does not support references as return types of tasks. "
                "Check the Qualcomm Symphony manual.");
...
protected:
  ...
  static_assert(arity < ::symphony::internal::set_arg_tracker::max_arity::value,
                "Task has too many arguments. Refer to the Qualcomm Symphony manual.");
